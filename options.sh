...
EPPCLIENT_WS_SERVER=18.199.196.214
...
#EPPCLIENT_DISABLE_CUPS_SYNC=0
#export EPPCLIENT_DISABLE_CUPS_SYNC

#EPPCLIENT_DISABLE_VPN_SCAN=0
#export EPPCLIENT_DISABLE_VPN_SCAN
